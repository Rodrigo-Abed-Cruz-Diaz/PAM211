...
export default function UsuarioView() {
  ...
  // NUEVO: UPDATE - Abrir modal para editar
        ...
        { text: 'Cancelar', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              ...
              Alert.alert('Usuario Eliminado', `"${usuarioEliminado.nombre}" eliminado correctamente`);
            } catch (error) {
              Alert.alert('Error', error.message);
            }
          }
  ...
  // Renderizar cada usuario (MODIFICADO)
  ...
  return (
    <View style={styles.container}>
      ...
      {/* NUEVO: Modal para editar usuario */}
      <Modal
        animationType="slide"
        transparent={true}

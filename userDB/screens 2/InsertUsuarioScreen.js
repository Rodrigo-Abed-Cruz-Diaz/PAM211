    ...
    <View style={styles.container}>
      ...
      <View style={styles.insertSection}>
        ...
        <TouchableOpacity 
          ...
          onPress={handleAgregarUsuario}  // CORREGIDO: agregada la función
          disabled={guardando} >
      ...
      <View style={styles.selectSection}>
        ...
        <View style={styles.selectHeader}>
          ...
          <TouchableOpacity 
            ...
            onPress={handleRecargar} >  {/* CORREGIDO: agregada la función */}
        ...
        {loading ? (
          ...
          <FlatList
            data={usuarios}  // CORREGIDO: agregado el array de usuarios
            keyExtractor={(item) => item.id.toString()}
            renderItem={renderUsuario}  // CORREGIDO: agregada la función de renderizado
            ListEmptyComponent={
